...
const HomePage = () => {
    return (<div className="font-beatrice tracking-2px mx-[3.125rem] my-[4.375rem]">
        ...
        <section className="flex flex-col gap-[1.875rem]">
            <div className="flex justify-between items-end">
                <div className="flex items-center gap-0.5 font-beatrice-extrabold">
                    <h1 className="text-5xl leading-10 text-black">
                        NEW<br />
                        THIS WEEK
                    </h1>
                    <p className="text-xl text-[#000E8A]">
                        (50)
                    </p>
                </div>
                <button className='font-beatrice tracking-normal text-sm'> See All</button>
            </div>
                    ...
                    <div className="flex justify-between items-end w-full">
                        <div className="flex flex-col gap-2">
                            <div className="flex flex-row items-center">
                                <p className="font-beatrice-medium text-xs opacity-65 text-black tracking-normal">
                                    V-Neck T-Shirt
                                </p>
                                <div className="w-3 h-3 bg-black ml-1.5 mr-0.5"></div>
                                <p className="font-beatrice-light text-sm opacity-65 text-black">+5</p>
                            </div>
                            <p className="font-beatrice-medium text-base tracking-normal">
                                Embroidered Seersucker Shirt
                            </p>
                        </div>
                        <div className="ont-beatrice-medium text-base tracking-normal">
                            $ 99
                        </div>
                    </div>
                </div>
